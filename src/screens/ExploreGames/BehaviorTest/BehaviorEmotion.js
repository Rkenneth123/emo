...
export default function BehaviorEmotionScreen({ navigation }) {
  ...
  const handleLevel1 = () => {
    navigation.navigate('BehaviorEmotionLevel1');
  };
  const handleLevel2 = () => {
    if (lockLevel2) {
  ...
  const unlockLevel2 = async () => {
    const score = await AsyncStorage.getItem('BehaviorLevel1');
  ...
  const unlockLevel3 = async () => {
    const score = await AsyncStorage.getItem('BehaviorLevel2');
    let finalScore = parseInt(score);
  ...
  const unlockLevel4 = async () => {
    const score = await AsyncStorage.getItem('BehaviorLevel3');
    let finalScore = parseInt(score);
  ...
  const unlockLevel5 = async () => {
    const score = await AsyncStorage.getItem('BehaviorLevel4');
    let finalScore = parseInt(score);
  ...
  return (
    <ImageBackground
      source={require('../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/BehaviorEmotion.png')}
        ...
        <View style={styles.bodyContent}>
          ...
          <TouchableOpacity onPress={handleLevel2}>
            <View style={styles.levelsContainer}>
              <Image
                source={require('../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level2.png')}
                style={styles.bodyItem}
              />
              {lockLevel2 ? (
                <Image
                  source={require('../../../../assets/NewAssets/ExploreGames/GuessEmotion/Lock.png')}
          ...
          <TouchableOpacity onPress={handleLevel3}>
            <View style={styles.levelsContainer}>
              <Image
                source={require('../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level3.png')}
                style={styles.bodyItem}
              />
              {lockLevel3 ? (
                <Image
          ...
          <TouchableOpacity onPress={handleLevel4}>
            <View style={styles.levelsContainer}>
              <Image
                source={require('../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level4.png')}
                style={styles.bodyItem}
              />
              {lockLevel4 ? (
                <Image
          ...
          <TouchableOpacity onPress={handleLevel5}>
            <View style={styles.levelsContainer}>
              <Image
                source={require('../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level5.png')}
                style={styles.bodyItem}
              />
              {lockLevel5 ? (
                <Image
