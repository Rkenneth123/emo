...
export default function BehaviorLevel5({ navigation }) {
  ...
  const handleNextLevel = async () => {
    if (score >= 3) {
      Alert.alert('You completed all the levels');
    } else {
      Alert.alert('Your score is below 3. Please try again');
    }
  };
        ...
        {showFinalResults ? (
          <View style={styles.finalResultMainContainer}>
            <View style={styles.finalResultContainer}>
              {score >= 3 ? (
                <View>
                  <Text>Accomplish All Level</Text>
                  <Image
