...
export default function BehaviorLevel1({ navigation }) {
  ...
  const handleNextLevel = async () => {
    if (score >= 3) {
      navigation.navigate('BehaviorEmotionLevel2');
    } else {
  ...
  const optionClicked = async (isCorrect) => {
    ...
    if (currentQuestion + 1 < questions.length) {
      ...
      await AsyncStorage.setItem('BehaviorLevel1', (score + 1).toString());
    }
  };
  const load = async () => {
        ...
        <View style={styles.modalContainer}>
          <View style={styles.itemContainer}>
            ...
            <TouchableOpacity onPress={() => setOpenModal(false)}>
              <Image
                source={require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/close.png')}
                style={styles.close}
              />
            </TouchableOpacity>
        ...
        {showFinalResults ? (
          <View style={styles.finalResultMainContainer}>
            <View style={styles.finalResultContainer}>
              {score >= 3 ? (
                <View>
                  <Text>New Achievement Unlock – Behavior Test Level 2</Text>
                  <Image
