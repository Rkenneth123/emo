...
import { View, StatusBar, Alert, StyleSheet, Image, TouchableOpacity, Modal,ImageBackground, Text } from 'react-native';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { useRoute } from '@react-navigation/native';

export default function BehaviorLevel4({ navigation }) {
  ...
  const handleNextLevel = async () => {
    if (score >= 3) {
      navigation.navigate('BehaviorEmotionLevel5');
    } else {
  ...
  const questions = [
    {
      level: 1,
      page: 1,
      main: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L4-2.png'),
      options: [
        {
          id: 0,
          path: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L4-3.png'),
          alt: '',
          isCorrect: true,
        },
        {
          id: 1,
          path: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L4-1.png'),
          alt: '',
          isCorrect: false,
        },
      ],
    },
    {
      level: 2,
      page: 2,
      main: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L1-2.png'),
      options: [
        {
          id: 0,
          path: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L1-1.png'),
          alt: '',
          isCorrect: false,
        },
        ...
        {
          id: 1,
          path: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L1-3.png'),
          alt: '',
          isCorrect: true,
        },
      ],
    },
    {
      level: 3,
      page: 3,
      main: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L2-2.png'),
      options: [
        {
          id: 0,
          path: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L2-3.png'),
          alt: '',
          isCorrect: true,
        },
        {
          id: 1,
          path: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L2-1.png'),
          alt: '',
          isCorrect: false,
        },
        {
          id: 2,
          path: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L2-4.png'),
          alt: '',
          isCorrect: false,
        },
      ],
    },
    {
      level: 4,
      page: 4,
      main: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L3-1.png'),
      options: [
        {
          id: 0,
          path: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L3-3.png'),
          alt: '',
          isCorrect: false,
        },
        {
          id: 1,
          path: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L3-2.png'),
          alt: '',
          isCorrect: true,
        },
      ],
...

    {
      level: 5,
      page: 5,
      main: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L5-1.png'),
      options: [
        {
          id: 0,
          path: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L5-3.png'),
          alt: '',
          isCorrect: false,
        },
        {
          id: 1,
          path: require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/L5-2.png'),
          alt: '',
          isCorrect: true,
        },
      ],
  ...
  const optionClicked = async (isCorrect) => {
    ...
    if (currentQuestion + 1 < questions.length) {
      ...
      await AsyncStorage.setItem('BehaviorLevel4', (score + 1).toString());
    }
  };
  const load = async () => {
  ...
  return (
    <ImageBackground
      source={require('../../../../../assets/NewAssets/ExploreGames/BehaviorEmotion/Level1/Guess_BG.png')}
        ...
        {showFinalResults ? (
          <View style={styles.finalResultMainContainer}>
            <View style={styles.finalResultContainer}>
              {score >= 3 ? (
                <View>
                  <Text>New Achievement Unlock – Behavior Test Level 5</Text>
                  <Image
