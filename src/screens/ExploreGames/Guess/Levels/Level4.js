...
export default function GuessLevel4({ navigation }) {
  ...
  const handleNextLevel = async () => {
    if (score >= 3) {
      navigation.navigate('GuessEmotionLevel5');
    } else {
  ...
  const questions = [
    {
      level: 1,
      page: 1,
      main: require('../../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level1/page2.png'),
      options: [
        {
          id: 0,
        ...
        {
          id: 1,
          path: require('../../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level1/love.png'),
          alt: 'love',
          isCorrect: true,
        },
        {
    ...
    },
    {
      level: 2,
      page: 2,
      main: require('../../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level1/page1.png'),
      options: [
        {
          id: 0,
          path: require('../../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level1/happy.png'),
...

    {
      level: 3,
      page: 3,
      main: require('../../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level1/page4.png'),
      options: [
        {
          id: 0,
          path: require('../../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level1/happy.png'),
    ...
    },
    {
      level: 4,
      page: 4,
      main: require('../../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level1/page3.png'),
      options: [
        {
          id: 0,
          path: require('../../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level1/happy.png'),
    ...
    },
    {
      level: 5,
      page: 5,
      main: require('../../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level1/page5.png'),
      options: [
        {
          id: 0,
          path: require('../../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level1/happy.png'),
  ...
  const optionClicked = async (isCorrect) => {
    ...
    if (currentQuestion + 1 < questions.length) {
      ...
      await AsyncStorage.setItem('GuessLevel4', (score + 1).toString());
    }
  };
  const load = async () => {
      ...
      <Modal visible={openModal} animationType='fade' transparent={true}>
        <View style={styles.modalContainer}>
          <View style={styles.itemContainer}>
            ...
            <Image source={require('../../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level1/close.png')} style={styles.close} />
            </TouchableOpacity>
  ...
  return (
    <ImageBackground
      source={require('../../../../../assets/NewAssets/ExploreGames/GuessEmotion/Level1/Guess_BG.png')}
        ...
        {showFinalResults ? (
          <View style={styles.finalResultMainContainer}>
            <View style={styles.finalResultContainer}>
              {score >= 3 ? (
                <View>
                  <Text>New Achievement Unlock – Guess Emotion Level 5</Text>
                  <Image
