...
export default function GuessEmotionScreen({ navigation }) {
  ...
  const handleLevel1 = () => {
    navigation.navigate('GuessEmotionLevel1');
  };
  const handleLevel2 = () => {
    if (lockLevel2) {
      Alert.alert('Please Complete Level 1');
    } else {
      navigation.navigate('GuessEmotionLevel2');
    }
  };
  const handleLevel3 = () => {
    if (lockLevel3) {
      ...
      navigation.navigate('GuessEmotionLevel3');
    }
  };
  const handleLevel4 = () => {
    if (lockLevel4) {
      ...
      navigation.navigate('GuessEmotionLevel4');
    }
  };
  const handleLevel5 = () => {
    if (lockLevel5) {
  ...
  const unlockLevel2 = async () => {
    const score = await AsyncStorage.getItem('GuessLevel1');
  ...
  const unlockLevel3 = async () => {
    const score = await AsyncStorage.getItem('GuessLevel2');
    let finalScore = parseInt(score);
  ...
  const unlockLevel4 = async () => {
    const score = await AsyncStorage.getItem('GuessLevel3');
    let finalScore = parseInt(score);
  ...
  const unlockLevel5 = async () => {
    const score = await AsyncStorage.getItem('GuessLevel4');
    let finalScore = parseInt(score);
  ...
  return (
    <ImageBackground
      source={require('../../../../assets/NewAssets/ExploreGames/GuessEmotion/GUESSEMOTION.png')}
